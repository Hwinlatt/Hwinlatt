...
<body>
    <!--Alert Start-->
    <div class="alertBox position-fixed   top-50 start-50 translate-middle d-none" style="z-index: 10">
        <div class="alert rounded shadow px-2 alert-danger w-100 position-relative" role="alert">
            ...
            <div class="d-flex justify-content-center">
                <button type="button" class="btn-sm di- btn-primary btn-rounded rounded closeBtn">Close</button>
            </div>
    ...
    <div class="container-scroller">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
                <a class="sidebar-brand brand-logo" href="index.html"><img src="{{ asset('backend/images/logo.svg') }}"
                        alt="logo" /></a>
            ...
            <ul class="nav sideBar">
                    ...
                    <div class="profile-desc">
                        <div class="profile-pic">
                            <div class="count-indicator">
                                <img class="img-xs rounded-circle " src="{{ asset('backend/images/logo-mini.svg') }}"
                                    alt="">
                ...
                <li class="nav-item menu-items dashboard">
                ...
                <li class="nav-item menu-items category">
                    ...
                    <div class="collapse" id="ui-basic">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item "> <a class="nav-link" href="{{ route('admin#add_category') }}">Add
                                    Category</a>
                            </li>
                            <li class="nav-item"> <a class="nav-link"
                                    href="{{ route('admin#category') }}">Categories</a></li>
                            <li class="nav-item"> <a class="nav-link" href="pages/ui-features/typography.html"></a>
                            </li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item menu-items" id="order">
                    ...
                    <div class="collapse" id="orders">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link" href="{{ route('admin#orders') }}">Order
                                    List</a>
                            </li>
                ...
                <li class="nav-item menu-items editPage">
                    <a class="nav-link  " href="{{ route('admin#edit_page') }}">
                        <span class="menu-icon">
                ...
                <li class="nav-item menu-items userList">
                    <a href="{{route('admin#users')}}" class="nav-link" href="pages/icons/mdi.html">
                        <span class="menu-icon">
                ...
                <li class="nav-item menu-items catTypes">
                    <a href="{{route('admin#cat_types')}}" class="nav-link" href="pages/icons/mdi.html">
                        <span class="menu-icon">
                            <i class="mdi mdi-format-list-bulleted-type"></i>
                        </span>
                        <span class="menu-title">Category Types</span>
                    </a>
                </li>
                ...
                <ul class="navbar-nav navbar-nav-right">
                    <li class="nav-item dropdown d-none d-lg-block">
                        ...
                        <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list"
                            ...
                            <div class="dropdown-divider"></div>
                            <a href="{{ route('admin#add_category') }}" class="dropdown-item preview-item">
                                <div class="preview-thumbnail">
                                    <div class="preview-icon bg-dark rounded-circle">
                                        <i class="mdi mdi-table-column-plus-before text-primary"></i>
                                    </div>
                                </div>
                                <div class="preview-item-content">
                            ...
                            <div class="dropdown-divider"></div>
                            <a href="{{ route('admin#add_widget_page') }}" class="dropdown-item preview-item">
                                <div class="preview-thumbnail">
                                    <div class="preview-icon bg-dark rounded-circle">
                                ...
                                <div class="preview-item-content">
                                    <p class="preview-subject ellipsis mb-1">Home Page Widget</p>
                                </div>
                            </a>
                            <div class="dropdown-divider"></div>
